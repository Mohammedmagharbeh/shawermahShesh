...
function OtpVerification() {
  ...
  return (
    // درجة الخلفية الكلية المحيطة بالفورم bg-[#002080] بدلاً من الأحمر الداكن
    <div className="flex justify-center items-center min-h-screen bg-[#002080]">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        // درجة كارد الفورم نفسه bg-[#002db3] مع حواف زرقاء متناسقة
      ...
      >
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            // تغيير لون الأيقونة الداخلي ليصبح متناسقاً مع كارد الأزرق الجديد text-[#002db3]
            className="h-10 w-10 text-[#002db3]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
