        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 min-[30rem]:grid-cols-2 gap-3">
            <Input
              ...
              value={form.name?.ar || ""}
              onChange={(e) =>
                setForm({ name: { ...form.name, ar: e.target.value } })
              }
              required
              dir="rtl"
            />
            <Input
              ...
              value={form.name?.en || ""}
              onChange={(e) =>
                setForm({ name: { ...form.name, en: e.target.value } })
              }
              required
              dir="ltr"
            />
          ...
          <div className="flex flex-col-reverse min-[30rem]:flex-row gap-2">
            {editingId && (
              <Button
                ...
                variant="ghost"
                onClick={resetForm}
                className="min-[30rem]:w-auto w-full"
              >
            ...
            <Button
              type="submit"
              className="min-[30rem]:w-auto w-full flex-1 min-[30rem]:flex-none"
            >
