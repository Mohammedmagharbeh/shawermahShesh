...
//                                   {addition.price > 0 && ` (+${addition.price.toFixed(2)})`}
//                                 </Badge>
//                               ))}
//                             </div>
//                           )}
...
import { Card, CardContent, CardHeader } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Package, Calendar, CreditCard, MapPin, Truck, Tag } from "lucide-react";
import burger from "@/assets/burger.jpg";
import {
  Select,
  SelectContent,
            ...
            >
              <CardHeader className="bg-muted/50 border-b p-4 sm:p-6">
                <div className="flex flex-col gap-4">
                  ...
                  {/* ✅ جديد — شارة كود الخصم إذا كان مطبق على الطلب */}
                  {promo.hasPromo && (
