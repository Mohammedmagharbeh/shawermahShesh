...
//         await axios.post(`${SERVER_URL}/slides`, form);
//       }
//       setForm({ title: { ar: '', en: '' }, subtitle: { ar: '', en: '' }, image: '', relatedTo: '' });
//       setEditId(null);
//       fetchSlides();
//     } catch (error) {
//       console.error("Error saving slide:", error);
...
//                 className={`flex-1 ${currentLang === 'ar' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
//               >
//                 العربية
//               </Button>
//               <Button
...
//                 className={`flex-1 ${currentLang === 'en' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
//               >
//                 English
//               </Button>
//             </div>
...
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-2">
//                 العنوان ({currentLang === 'ar' ? 'العربية' : 'English'})
//               </label>
//               <Input
//                 placeholder={currentLang === 'ar' ? "أدخل عنوان السلايد" : "Enter slide title"}
//                 value={form.title[currentLang]}
//                 onChange={(e) => setForm({
//                   ...form,
//                   title: { ...form.title, [currentLang]: e.target.value }
//                 })}
//                 className="w-full"
//               />
//             </div>
...
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-2">
//                 الوصف ({currentLang === 'ar' ? 'العربية' : 'English'})
//               </label>
//               <Input
//                 placeholder={currentLang === 'ar' ? "أدخل وصف السلايد" : "Enter slide subtitle"}
//                 value={form.subtitle[currentLang]}
//                 onChange={(e) => setForm({
//                   ...form,
//                   subtitle: { ...form.subtitle, [currentLang]: e.target.value }
//                 })}
//                 className="w-full"
//               />
//             </div>
