...
function Header() {
  ...
  return (
    <div className="border-b border-border/50 bg-card/50 backdrop-blur-sm sticky top-0 z-10 w-full">
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 mt-4 sm:mt-6 lg:mt-10">
