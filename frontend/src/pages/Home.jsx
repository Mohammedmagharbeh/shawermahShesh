...
//             const uniqueCategories = ["الكل", ...new Set(data.map((p) => p.category))]
...
//               <img
//                 src="/delicious-shawarma-and-shish-restaurant-food.jpg"
//                 alt="شاورما شيش"
...
//                     <div className="flex items-center justify-between">
//                       <div className="text-2xl font-bold text-red-700">{product.price} ر.س</div>
//                       <Button
...
//                 منذ أكثر من 15 عاماً ونحن نقدم أفضل أنواع الشاورما والشيش بجودة عالية وطعم أصيل. نستخدم أجود المكونات
//                 ونتبع أفضل الطرق التقليدية في التحضير.
//               </p>
...
//             <div>
//               <img
//                 src="/traditional-middle-eastern-restaurant-kitchen-chef.jpg"
//                 alt="مطبخنا"
//                 className="rounded-2xl shadow-xl w-full h-auto"
//               />
//             </div>
...
//             <p className="text-lg text-gray-600">فريقنا جاهز لخدمتكم على مدار الساعة</p>
//           </div>
...
//             <p className="text-gray-400 mb-6">طعم لا يُنسى منذ 2009</p>
...
//                 <span className="font-bold">50,000+</span> عميل سعيد
//               </div>
//             </div>
