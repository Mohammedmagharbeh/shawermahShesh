...
//       // معالجة المستخدمين وربطهم بالطلبات عن طريق رقم الهاتف
//       const processedUsers = usersData.map((user) => {
//         const userNormalizedPhone = normalizePhone(user.phone)
//         const userOrders = ordersData.filter(
//           (order) => normalizePhone(order.userId?.phone || order.phone) === userNormalizedPhone
//         )
...
//         processedUsers.length > 0 ? (usersWithOrders / processedUsers.length) * 100 : 0
