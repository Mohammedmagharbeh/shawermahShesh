...
// // orangeMoneyService.js (Controller)
...
// //   console.log("=== FULL SERVICERS RESPONSE ===", JSON.stringify(response.data, null, 2));

// //   const data = response.data;
// //   const servicers = data?.Response || data?.response || data?.Result || [];
// //   return servicers.filter((s) => ["1", "2", "3"].includes(s.RTPMethod));
// // }
...
// //   console.log("=== VALIDATE RESPONSE ===", JSON.stringify(response.data, null, 2));
// //   return response.data;
// // }
...
// //   console.log("=== CONFIRM RESPONSE ===", JSON.stringify(response.data, null, 2));
// //   return response.data;
// // }
...
// //   console.log("=== INQUIRY RESPONSE ===", JSON.stringify(response.data, null, 2));
// //   return response.data;
// // }
...
async function getServicers() {
  ...
  // ✅ فلتر بس Orange Money (ORNGJOPX) وبدون باقي البنوك
  return servicers.filter((s) => {
    const code = s.ServicerCode || s.servicerCode || "";
    const rtpMethod = s.RTPMethod;
    return ["1", "2", "3"].includes(rtpMethod) && code === "ORNGJOPX";
  });
}
